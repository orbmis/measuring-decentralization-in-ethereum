...
%     xticklabels from table={data/master_index.dat}{Date},
%     legend style={at={(0.5,-0.15)},
%       anchor=north,legend columns=-1},
%     ]
%     
% \addplot table [x expr=\coordindex, y=Gini, col sep=space] {data/master_index.dat};
% \addplot table [x expr=\coordindex, y=HHI, col sep=space] {data/master_index.dat};
% 
% \legend{Gini, HHI, Shannon}
% \end{axis}
% \end{tikzpicture}
...
Through measuring the Exchanges by Supply we see a relatively high level of concentration among the top exchanges in the ecosystem.  It is worth noting though that Coinbase is missing from this list!!

\begin{figure}[ht]
    \begin{tikzpicture}
        \begin{axis}[
            ybar,
            symbolic x coords={Binance, Bitfinex, Bitstamp, Bittrex, Gemini, Huobi, Kraken, Poloniex},
            xtick=data,
            xticklabel style={rotate=45, anchor=north east},
        ...
        \addplot coordinates {(Binance, 4152789) (Bitfinex, 2292666) (Bitstamp, 59161) (Bittrex, 68555) (Gemini, 489367) (Huobi, 71959) (Kraken, 1799885) (Poloniex, 7603)};
        \end{axis}
    \end{tikzpicture}
...
We observe the highest value for the Gini index in teh Stablecoins by TVL metric.
