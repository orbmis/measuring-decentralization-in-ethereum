...
In this section we discuss the results of the application of our model to a sample that was recorded at 24 hour interval across a period of 30 days, between the 23\textsuperscript{rd} June 2023 to the 23\textsuperscript{rd} of July 2023.  We discuss how our results demonstrate our hypothesis that decentralization is a dynamic quality that changes over time, rather than static quality is maintained in continuous equilibrium. The results have been organized into sections broadly corresponding to the categories of metrics as described in section I.
...
Execution Nodes by Country & \cellcolor[HTML]{FF9F80}0.85 & \cellcolor[HTML]{D9FF80}0.22 & \cellcolor[HTML]{FFE580}0.52 & \cellcolor[HTML]{FFEC80}0.49 \\
Execution Nodes by Client & \cellcolor[HTML]{FFB080}0.77 & \cellcolor[HTML]{FFEA80}0.5 & \cellcolor[HTML]{FFF780}0.44 & \cellcolor[HTML]{E6FF80}0.28 \\
Consensus Nodes by Country & \cellcolor[HTML]{FF9D80}0.86 & \cellcolor[HTML]{D0FF80}0.18 & \cellcolor[HTML]{FFE880}0.51 & \cellcolor[HTML]{FFEA80}0.5 \\
Consensus Nodes by Client & \cellcolor[HTML]{FFCE80}0.63 & \cellcolor[HTML]{EEFF80}0.32 & \cellcolor[HTML]{E6FF80}0.28 & \cellcolor[HTML]{EAFF80}0.3 \\
Amount Staked by Pool & \cellcolor[HTML]{FF9580}0.9 & \cellcolor[HTML]{D5FF80}0.2 & \cellcolor[HTML]{FFD280}0.61 & \cellcolor[HTML]{FFDF80}0.55 \\
Native Assets by Address & \cellcolor[HTML]{FFB380}0.76 & \cellcolor[HTML]{FFFF80}0.4 & \cellcolor[HTML]{FFF780}0.44 & \cellcolor[HTML]{F0FF80}0.33 \\
Exchange by Supply & \cellcolor[HTML]{FFCA80}0.65 & \cellcolor[HTML]{F0FF80}0.33 & \cellcolor[HTML]{E8FF80}0.29 & \cellcolor[HTML]{EAFF80}0.3 \\
Activity by Bundler & \cellcolor[HTML]{C4FF80}0.12 & \cellcolor[HTML]{FFE380}0.53 & \cellcolor[HTML]{ACFF80}0.01 & \cellcolor[HTML]{BFFF80}0.1 \\
Stablecoins by Tvl & \cellcolor[HTML]{FF8C80}0.94 & \cellcolor[HTML]{F7FF80}0.36 & \cellcolor[HTML]{FFBD80}0.71 & \cellcolor[HTML]{FFD780}0.59 \\
Rollups by Tvl & \cellcolor[HTML]{FF9B80}0.87 & \cellcolor[HTML]{FFF080}0.47 & \cellcolor[HTML]{FFDF80}0.55 & \cellcolor[HTML]{FFF480}0.45 \\
Blocks by Builder & \cellcolor[HTML]{FFAE80}0.78 & \cellcolor[HTML]{D5FF80}0.2 & \cellcolor[HTML]{FFF980}0.43 & \cellcolor[HTML]{FFF980}0.43 \\
Blocks by Relays & \cellcolor[HTML]{FFD780}0.59 & \cellcolor[HTML]{DBFF80}0.23 & \cellcolor[HTML]{DDFF80}0.24 & \cellcolor[HTML]{F0FF80}0.33 \\ \hline
\end{tabular}
\end{center}
...
\begin{axis}[
  xtick={0,5,...,30},
  minor xtick={0,1,...,30},
  xticklabels={May 23,May 28,Jun 2,Jun 7,Jun 12,Jun 17},
...
% \addplot table [x expr=\coordindex, y=BlocksByRelays] {data/HHI_block_builders_relays.dat};
% \addplot table [x expr=\coordindex, y=BlocksByBuilder] {data/HHI_block_builders_relays.dat};
